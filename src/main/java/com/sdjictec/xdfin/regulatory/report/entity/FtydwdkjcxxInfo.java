...
public class FtydwdkjcxxInfo implements Serializable {
    ...
    public String getDkffrq() {
        return ExcelDateUtil.getDateStr(dkffrq);
    }

    public String getYsdqrq() {
        return ExcelDateUtil.getDateStr(ysdqrq);
    }
